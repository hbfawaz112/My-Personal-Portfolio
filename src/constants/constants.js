export const projects = [
  ...
  {
    title: 'FCSS Web Site',
    description: "Fawaz Computer & Security System a small company located in Tebnin, this project is a web site for this business contain E-commerce section with add to cart, product detail , check out , a contact page and a store page and more coming out later.., Build using React and designed using Material UI",
